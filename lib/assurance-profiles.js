...
const PROFILES = Object.freeze([
  ...
  },
  {
    ...
    does_not: null,
    why_empty:
      'RECORDED from raw GitHub dumps of coderifts/demo (ruleset 22074842, PR#10 FAILURE + PR#5 SUCCESS). '
      + 'ADV-1 remains DECISION_LOGIC — a local mirror is not a provider refusing anything. '
      + 'Capture is a local gh token dump, not a GitHub-signed object and not OIDC. '
      + 'mergeStateStatus is BEHIND on both poles; the CHECK verdict is the evidence, not a 405 merge. '
