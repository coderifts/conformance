...
const PROFILES = Object.freeze([
  ...
  },
  {
    ...
    why_empty:
      ...
      + 'FAILURE+BLOCKED + PR#5 required-context SUCCESS). ADV-1 remains DECISION_LOGIC — a local '
      + 'mirror is not a provider refusing anything. Capture is a local gh token dump, not a '
      + 'GitHub-signed object and not OIDC. Live mode without gh is NOT_RUN and does not fall back. '
      + 'does_not_prove is non-empty.',
  },
  {
    id: 'END_TO_END',
